"""
Task 1 Program 1 (Topic A, Ollama): MMLU single-subject evaluation via Ollama API.

Default subject: astronomy
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Topic A MMLU eval using Ollama.")
    ...
    out_name = f"task1_topicA_ollama_{timestamp}.json"
